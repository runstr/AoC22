...
def bfs(mappings, start_point, end_point, max_x, max_y, start_time):
    visited = set()
    queue = []
    startpoint = (start_point[0], start_point[1], start_time)
...
def get_my_answer():
    ...
    final_time = bfs(mappings, start_point, end_point, max_x, max_y, 0)
    final_time = bfs(mappings, end_point, start_point, max_x, max_y, final_time)
    final_time = bfs(mappings, start_point, end_point, max_x, max_y, final_time)
    return final_time
